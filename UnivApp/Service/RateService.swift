...
//            Alamofire().getAlamofire(url: "\(APIEndpoint.topEmployment.urlString)\(universityId)")
//                .sink { completion in
//                    switch completion {
//                    case .finished:
//                        print("취업률 조회 성공")
...
//            Alamofire().getAlamofire(url: "\(APIEndpoint.topCompetition.urlString)\(universityId)")
//                .sink { completion in
//                    switch completion {
//                    case .finished:
//                        print("경쟁률 조회 성공")
